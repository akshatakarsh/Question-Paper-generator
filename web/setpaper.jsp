...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="Question.jsp"> <i class="menu-icon fa fa-question"></i>Questions</a>

                    </li>  
                    <li class="active">
                        <a href="setpaper.jsp"> <i class="menu-icon fa fa-file"></i>Paper</a>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill"></span> <%=msg %>
  ...
  <div class="row">
      <form action="setpaperpro.jsp" method="get">
    <div class="form-group col-sm-4">
      <label for="inputEmail4">Paper Name</label>
      <input type="text"  name="paper"class="form-control" id="inputEmail4" placeholder="Enter Paper Name">
    </div>
    <div class="form-group col-sm-4">
      <label for="inputState">Branch</label>
      <select name="branch" id="inputState" class="form-control">
          <% 
             HashMap hm1=db.getBranchDetails(email);
             for(int i=2;i<hm1.size();){
          %>
        <option name="branch" value="<%=hm1.get(i)%>"><%=hm1.get(i)%></option>
       <% i=i+4;}%>
      </select>
  </div>
      <div class="form-group col-sm-4">
      ...
      <select name="subject"id="inputState" class="form-control">
          ...
          <% 
             HashMap hm2=db.getsubdetails(email);
             for(int i=5;i<hm2.size();){
          %>
          <option name="subject" value="<%=hm2.get(i)%>"><%=hm2.get(i)%></option>
         <% i=i+6;}%>
      </select>
       </div>
       
      <div class="form-group col-sm-2">
      <label for="inputState">Total Marks</label>
      <input type="text" name="tm" class="form-control">
       </div>
 <div class="form-group col-sm-2">
      <label for="inputState">Time Allowed</label>
      <input type="text" name="time"class="form-control" id="inputAddress" >
       </div>

  <div class="form-group col-sm-8">
    <label for="inputAddress">Question Paper Description</label>
    <input type="text" name="qpd"class="form-control" id="inputAddress">
  </div>
			...
			<table class="table table-bordered table-hover table-sortable" id="tab_logic">
				...
				<tbody>
    				<tr id='addr0' data-id="0" class="hidden">
						<td data-name=""><input type="text"  name="pid"class="form-control" ></td>
						...
						<td data-name="mail">
                                                    <table border="1">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>2</td>
                                                                 <td><input type="text"  name="qt2"style="width:50px"class=""/></td>
                                                                 <td>4</td>
                                                            </tr>
                                                        </tbody>
                                               ...
                                               <table border="1">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>4</td>
                                                                <td><input type="text" name="qt4" style="width:50px"class= ""  /></td>
                                                                 <td>4</td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <td>
                                                    <table border="1">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>5</td>
                                                                 <td><input type="text" name="qt5" style="width:50px"/></td>
                                                                 <td>4</td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <td>
                                                    <table border="1">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>7</td>
                                                                 <td><input type="text" name="qt7" style="width:50px"class=""/></td>
                                                                 <td>4</td>
                                                            </tr>
                                                        </tbody>
