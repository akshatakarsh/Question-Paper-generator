...
<% 
    ...
    if(email!=null){
      String x = (String)session.getAttribute("msg");
               ...
               <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="forgetpass.jsp">Forget Password</a></li>
                            <li><i class="menu-icon fa fa-paper-plane"></i><a href="Register.jsp">Register</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Note :</span> <%=x %>
                    <% session.setAttribute("msg", "Welcome "+(String)hm.get("name"));%>
                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <div class="chart-wrapper px-0" style="height:70px;" height="70">
                           <a href="Branch.jsp" style="color:white"><b>More Info<b></a>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <div class="chart-wrapper px-0" style="height:70px;" height="70">
                            <a href="Subject.jsp" style="color:white"><b>  More Info<b></a>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    ...
                    <div class="chart-wrapper px-0" style="height:70px;" height="70">
                    <a href="Question.jsp"style="color:white"><b> More Info</b></a>
                    </div>
                ...
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        ...
                        <div class="chart-wrapper px-3" style="height:70px;" height="70">
                            <a href="setpaper1.jsp" style="color:white"><b>More Info</b></a>
                        </div>
                        ...
                        <% 
              HashMap hm1=m1.getsubdetails(email);
                    %>

<div class="row">
      <form action="unit.jsp" method="get">
    <div class="form-group col-sm-8">
      <label for="inputEmail4">Search Unit By Subject</label>
