...
<div class="container">
	<div class="row">
            <div class="col-md-6">
                ...
                <Button style="margin-left:80%"class="btn-primary  text-center" type="submit">Add Unit</button>
                </form>
            </div>
    ...
    <tbody>
    <% 
   HashMap hm1=db.getUnitDetails();
   HashMap hm2=db.getsubcodebyunit(subject);
   String b=(String)hm2.get(1);
  
   HashMap branch= db.getBranchBySubject(subject);
  HashMap hm3=db.getDetailsbybranchsub(subject, (String)branch.get(1));
...
session.setAttribute("msg","There is no unit added to "+subject);
